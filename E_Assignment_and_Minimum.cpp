...
class lazy_segment_tree {
    ...
    int query_op(int a, int b) { return min(a, b); }
    int update_op(int a, int b) { return (b == update_default_val ? a : b); }
    ...
    void update(int l, int r, int v, int curr, int L, int R) {
        ...
        seg[curr].query = update_op(query_op(seg[curr*2].query, seg[curr*2+1].query), seg[curr].update);
    }
